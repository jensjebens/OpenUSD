...
option(PXR_BUILD_USDBREP_PLUGIN "Build usd-brep tessellation plugin for BrepArray" OFF)
...
if (${PXR_BUILD_USDBREP_PLUGIN})
    if (NOT ${PXR_BUILD_IMAGING})
        message(STATUS
            "Setting PXR_BUILD_USDBREP_PLUGIN=OFF because PXR_BUILD_IMAGING=OFF")
        set(PXR_BUILD_USDBREP_PLUGIN "OFF" CACHE BOOL "" FORCE)
    endif()
endif()
...
if (${PXR_BUILD_OCCT_PLUGIN})
    if (NOT ${PXR_BUILD_IMAGING})
        message(STATUS
            "Setting PXR_BUILD_OCCT_PLUGIN=OFF because PXR_BUILD_IMAGING=OFF")
        set(PXR_BUILD_OCCT_PLUGIN "OFF" CACHE BOOL "" FORCE)
    endif()
endif()
